...
DOMAIN_FEATURE_LABELS: dict[str, dict[str, str]] = {
    "restaurant": {
        ...
        "forecast_required_headcount_total": "Personal requerido",
        "actual_headcount_total": "Personal disponible",
        "scheduled_overtime_hours": "Horas extra del turno",
        "scheduled_avg_consecutive_work_days": "Dias consecutivos trabajados del equipo",
        "avg_hr_mean_bpm": "Ritmo cardiaco promedio del equipo",
        "avg_steps": "Movimiento promedio del equipo",
        "scheduled_avg_demand_pressure": "Presion de demanda programada",
        "deficit_count_total_lag1": "Deficit en el turno anterior",
        "deficit_count_total_lag7": "Deficit de la semana anterior",
        "absentee_rate_lag7": "Ausentismo de la semana anterior",
        "delivery_order_volume_lag1": "Pedidos delivery del turno anterior",
        "short_notice_absentee_rate_lag7": "Ausentismo de corto aviso de la semana anterior",
        "short_notice_absentee_rate_lag1": "Ausentismo de corto aviso del turno anterior",
        "reservation_count_lag1": "Reservas del turno anterior",
        "reservation_count_lag7": "Reservas de la semana anterior",
        "forecast_covers_lag1": "Cubiertos del turno anterior",
        "forecast_covers_lag7": "Cubiertos de la semana anterior",
        "forecast_sales_lag1": "Ventas del turno anterior",
        "forecast_sales_lag7": "Ventas de la semana anterior",
        "delivery_order_volume_lag7": "Pedidos delivery de la semana anterior",
        "absentee_rate_lag1": "Ausentismo del turno anterior",
        "day_of_week": "Dia de la semana",
        "is_peak_service": "Servicio en horario punta",
        "tourism_pressure_score": "Presion turistica",
        "weather_impact_score": "Impacto del clima",
        "avg_hrv_rmssd_ms": "Variabilidad cardiaca promedio del equipo",
        "avg_distance_to_work_km": "Distancia promedio al trabajo",
        "forecast_required_role_garzon": "Garzones requeridos",
        "forecast_required_role_host": "Host requeridos",
        "forecast_required_role_cajero": "Cajeros requeridos",
        "forecast_required_role_cocinero_linea": "Cocineros de linea requeridos",
        "forecast_required_role_ayudante_cocina": "Ayudantes de cocina requeridos",
        "forecast_required_role_runner": "Runners requeridos",
        "forecast_required_role_copero": "Coperos requeridos",
        "forecast_required_role_jefe_turno": "Jefes de turno requeridos",
    },
    "industrial": {
        ...
        "actual_headcount_lag1": "Dotacion real del periodo anterior",
        "actual_headcount_lag2": "Dotacion real de hace 2 periodos",
        "actual_headcount_lag3": "Dotacion real de hace 3 periodos",
        "actual_headcount_lag7": "Dotacion real de la semana anterior",
        "age": "Edad promedio del equipo",
        "area_shift_absentee_rate_lag1": "Ausentismo del periodo anterior",
        "area_shift_absentee_rate_lag2": "Ausentismo de hace 2 periodos",
        "area_shift_absentee_rate_lag3": "Ausentismo de hace 3 periodos",
        "area_shift_absentee_rate_lag7": "Ausentismo de la semana anterior",
        "bmi": "Carga fisica promedio del equipo",
        "day_of_week": "Dia de la semana",
        "distance_to_work_km": "Distancia promedio al trabajo",
        "fatigue_14d": "Fatiga acumulada 14 dias",
        "hr_mean_bpm": "Ritmo cardiaco promedio",
        "hr_mean_bpm_7d_mean": "Ritmo cardiaco promedio semanal",
        "hrv_rmssd_ms": "Variabilidad cardiaca",
        "hrv_rmssd_ms_7d_mean": "Variabilidad cardiaca promedio semanal",
        "hrv_rmssd_ms_trend": "Tendencia de variabilidad cardiaca",
        "is_friday": "Es viernes",
        "is_monday": "Es lunes",
        "sleep_efficiency_pct": "Eficiencia de sueno",
        "sleep_duration_hours_7d_mean": "Horas de sueno promedio semanal",
        "steps": "Movimiento promedio",
        "stress_score_7d_mean": "Estres promedio semanal",
        "stress_score_trend": "Tendencia de estres",
    },
    "clinic": {
        ...
        "absentee_rate_lag1": "Ausentismo del periodo anterior",
        "absentee_rate_lag7": "Ausentismo de la semana anterior",
        "active_care_stations_lag1": "Boxes activos del periodo anterior",
        "active_care_stations_lag7": "Boxes activos de la semana anterior",
        "average_wait_minutes_lag1": "Espera promedio del periodo anterior",
        "average_wait_minutes_lag7": "Espera promedio de la semana anterior",
        "avg_age": "Edad promedio del equipo",
        "avg_bmi": "Carga fisica promedio del equipo",
        "avg_commute_km": "Distancia promedio al trabajo",
        "avg_fatigue_proxy": "Fatiga promedio del equipo",
        "avg_hr_mean_bpm": "Ritmo cardiaco promedio del equipo",
        "avg_hrv_rmssd_ms": "Variabilidad cardiaca promedio del equipo",
        "avg_reaction_time_ms": "Tiempo de reaccion promedio del equipo",
        "avg_sleep_duration_hours": "Horas de sueno promedio",
        "avg_sleep_efficiency_pct": "Eficiencia de sueno promedio",
        "avg_steps": "Movimiento promedio del equipo",
        "avg_years_experience": "Experiencia promedio del equipo",
        "day_of_week": "Dia de la semana",
        "deficit_count_total_lag1": "Deficit del periodo anterior",
        "deficit_count_total_lag7": "Deficit de la semana anterior",
        "elective_block_pressure": "Presion de bloque electivo",
        "floating_staff_available": "Personal flotante disponible",
        "forecast_patient_volume_lag1": "Pacientes proyectados del periodo anterior",
        "forecast_patient_volume_lag7": "Pacientes proyectados de la semana anterior",
        "forecast_required_headcount_total": "Personal total requerido",
        "forecast_required_role_admision": "Personal de admision requerido",
        "forecast_required_role_coordinador_clinico": "Coordinadores clinicos requeridos",
        "forecast_required_role_enfermera": "Enfermeras requeridas",
        "forecast_required_role_medico": "Medicos requeridos",
        "forecast_required_role_tecnologo_medico": "Tecnologos medicos requeridos",
        "forecast_required_role_tens": "TENS requeridos",
        "high_acuity_cases": "Casos de alta complejidad",
        "high_acuity_cases_lag1": "Casos de alta complejidad del periodo anterior",
        "high_acuity_cases_lag7": "Casos de alta complejidad de la semana anterior",
        "imaging_backlog_cases": "Casos pendientes de imagenologia",
        "is_evening_shift": "Turno vespertino",
        "is_holiday": "Es dia feriado",
        "is_monday": "Es lunes",
        "is_payday_window": "Ventana de pago",
        "is_weekend": "Es fin de semana",
        "is_weekend_flag": "Es fin de semana",
        "month": "Mes",
        "no_show_count": "Pacientes que no asisten",
        "procedural_pressure_index": "Presion de procedimientos",
        "respiratory_alert_cases": "Casos de alerta respiratoria",
        "respiratory_alert_level": "Nivel de alerta respiratoria",
        "respiratory_case_ratio_lag1": "Carga respiratoria del periodo anterior",
        "respiratory_case_ratio_lag7": "Carga respiratoria de la semana anterior",
        "respiratory_pressure_index": "Presion respiratoria",
        "scheduled_avg_acuity_load_score": "Carga de agudez programada",
        "scheduled_avg_consecutive_work_days": "Dias consecutivos trabajados",
        "scheduled_avg_infection_exposure_score": "Exposicion a infecciones programada",
        "scheduled_avg_patient_load_score": "Carga de pacientes programada",
        "scheduled_overtime_hours": "Horas extra programadas",
        "scheduled_procedures_lag1": "Procedimientos agendados del periodo anterior",
        "scheduled_procedures_lag7": "Procedimientos agendados de la semana anterior",
        "short_notice_absentee_rate_lag1": "Ausentismo de corto aviso del periodo anterior",
        "short_notice_absentee_rate_lag7": "Ausentismo de corto aviso de la semana anterior",
        "station_pressure_index": "Presion de estaciones de atencion",
        "vaccination_campaign_flag": "Campana de vacunacion activa",
    },
}
        ...
        "drivers_up": [
            {
                ...
                "message": f"A mayor '{row['feature_label']}', mayor probabilidad de deficit.",
        ...
        "drivers_down": [
            {
                "feature": row["feature"],
                "feature_label": row["feature_label"],
                "message": f"A mayor '{row['feature_label']}', menor probabilidad de deficit.",
                "mean_abs_shap": float(row["mean_abs_shap"]),
                "mean_shap": float(row["mean_shap"]),
            }
    ...
    *,
    ...
    if not risk_segment_df.empty:
        ...
        risk_summary["segment_highlight"] = {
            ...
            "message": f"En el turno {strongest_segment_row['segment_label']}, '{strongest_segment_row['feature_label']}' es el factor de mayor influencia.",
        }
